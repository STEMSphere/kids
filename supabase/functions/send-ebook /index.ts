...
serve(async (req) => {
  try {
    ...
    if (ebookType === 'free_stem_study_system') {
      ...
      pdfUrl = 'https://raw.githubusercontent.com/STEMSphere/Learn/main/assets/The%20STEM%20Student%27s%20Secret%20Study%20System%20(1).pdf'
      ...
      pdfUrl = 'https://raw.githubusercontent.com/STEMSphere/Learn/main/assets/College%20Prep%20Secrets.pdf'
